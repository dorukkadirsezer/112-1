...
public class RedBlackTree {
	 ...
	 * 
	 * @return all value items traversed in inorder, with a space after each item
	 */
	...
	/**
	 * A node of a red-black tree stores a value item and references of the child
	...
	static class Node {
		...
		/**
		 * Constructs a red node with no value.
		 */
		public Node() {
		}
