...
public class DataBaseCourse {
	...
	public static Stack<Course> populate(String fileName) {
		...
		final String pathToDirectory = "src/cis112_2025_1_midterm_1_q1_group1";
	 ...
	 * @param courseStack
	 * @param instructor
	 * @return return total credits of all courses thought by instructor
	 */
	public static int creditsByInstructor(Stack<Section> sectionStack, 
